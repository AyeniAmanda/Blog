package com.amanda.week9.serviceImpl;
...
public class UserServiceImpl implements UserService {
 ...
 private final PostRepository postRepository;
    ...
    @Autowired
    public UserServiceImpl( LikeRepository likeRepository,CommentRepository commentRepository,PostRepository postRepository, UserRepository userRepository) {
    ...
    public RegisterResponse register(UserDto userDto) {
        ...
        return new RegisterResponse("successful", LocalDateTime.now(), user);
    ...
    public SearchCommentResponse searchComment(String keyword) {
        List<Comments> commentList = commentRepository.findByCommentContaining(keyword);
